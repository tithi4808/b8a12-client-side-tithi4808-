...
const Contactus = () => {
  ...
  return (
    <div id="contact" className="my-20 md:mt-20 lg:max-w-6xl mx-auto bg-blue-200 py-12">
       
       <h3 className="text-center text-3xl font-bold mt-4">Contact Us</h3>
        <p>We love hearing from our customers.If you have any questions about Asset Trackr,Please send us a message.</p>
